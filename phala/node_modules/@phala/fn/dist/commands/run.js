...
class Run extends core_1.Command {
    async run() {
        const { flags: { scriptArgs = [], experimentalAsync }, args: { script }, } = await this.parse(Run);
        const scriptPath = (0, utils_1.resolveToAbsolutePath)(script);
        const js = (0, node_fs_1.readFileSync)(scriptPath, 'utf8');
        const output = await (0, runQuickJs_1.runQuickJs)(js, scriptArgs, {
...
Run.flags = {
    ...
    experimentalAsync: core_1.Flags.boolean({

...
export default class Update extends PhatBaseCommand {
    ...
    static flags: {
        workflowId: import("@oclif/core/lib/interfaces").OptionFlag<number | undefined, import("@oclif/core/lib/interfaces/parser").CustomOptions>;
    ...
    run(): Promise<void>;
    getWorkflowId(): Promise<number>;
    promptWorkflowId(message?: string): Promise<number>;
}

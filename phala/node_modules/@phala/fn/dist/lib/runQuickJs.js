...
const phatjs_js_1 = require("../lib/phatjs/phatjs.js");
...
async function runQuickJs(code, args = [], options = { silent: false, isAsync: false }) {
    if (options.isAsync) {
        (0, phatjs_js_1.init)();
        const output = (0, phatjs_js_1.run)(['phatjs', '-c', code, '--', ...args]);
        return output;
    }

...
function createEip712Domain(api) {
  try {
    ...
    const version = (0, import_util.hexToString)(api.consts.evmAccountMapping.eip712Version.toString());
...
var import_util10 = require("@polkadot/api-contract/base/util");
...
var import_browserify_cipher = require("browserify-cipher");
var ALGO = "aes-256-gcm";
var AUTH_TAG_LENGTH = 32;
var toU8a = (param) => {
  if (typeof param === "string") {
    param = (0, import_util3.hexAddPrefix)(param);
    return (0, import_util3.hexToU8a)(param);
  }
  return param;
};
var encrypt = (data, key, iv) => {
  data = (0, import_util3.hexStripPrefix)(data);
  const cipher = (0, import_browserify_cipher.createCipheriv)(ALGO, toU8a(key), import_buffer.Buffer.from(toU8a(iv)));
  const enc = cipher.update(data, "hex", "hex");
  cipher.final();
  return `${enc}${cipher.getAuthTag().toString("hex")}`;
};
var decrypt = (enc, key, iv) => {
  enc = (0, import_util3.hexStripPrefix)(enc);
  const decipher = (0, import_browserify_cipher.createDecipheriv)(ALGO, toU8a(key), import_buffer.Buffer.from(toU8a(iv)));
  const authTag = (0, import_util3.hexToU8a)((0, import_util3.hexAddPrefix)(enc.slice(-AUTH_TAG_LENGTH)));
...
// src/pruntime/coders.ts
function encodeNumber(n, defaults = import_util4.BN_ZERO) {
  if (!n) {
    return defaults;
  }
  if (typeof n === "bigint") {
...
function InkQuerySidevmMessage(address, sidevmMessage) {
  return phalaTypes.createType("InkQuery", {
    ...
    data: {
      SidevmMessage: (0, import_util4.stringToHex)(JSON.stringify(sidevmMessage))
    }
  });
}
...
function EncryptedInkCommand(address, encParams, nonce, value, gas, storageDepositLimit) {
  ...
  const commandAgreementKey = (0, import_util_crypto2.sr25519Agreement)(sk, (0, import_util4.hexToU8a)(address));
  ...
  const iv = (0, import_util4.hexAddPrefix)(randomHex(12));
  return phalaTypes.createType("CommandPayload", {
    Encrypted: {
      iv,
      pubkey: (0, import_util4.u8aToHex)(pk),
      data: (0, import_util4.hexAddPrefix)(encrypt(payload.toHex(), commandAgreementKey, (0, import_util4.hexToU8a)(iv)))
    }
  });
}
...
function createEncryptedData(pk, data, agreementKey) {
  const iv = (0, import_util5.hexAddPrefix)(randomHex(12));
  return {
    iv,
    pubkey: (0, import_util5.u8aToHex)(pk),
    data: (0, import_util5.hexAddPrefix)(encrypt(data, agreementKey, (0, import_util5.hexToU8a)(iv)))
  };
}
async function pinkQuery(pruntimeApi, pk, queryAgreementKey, encodedQuery, { certificate, pubkey, secret }) {
  ...
  return (0, import_util5.hexAddPrefix)(data);
}
...
var import_util6 = require("@polkadot/util");
var BN_MAX_SUPPLY = new import_util6.BN(1e12).mul(new import_util6.BN(1e9));
...
var import_util7 = require("@polkadot/api-contract/base/util");
var import_util8 = require("@polkadot/api-contract/util");
    ...
    sinceSubmitted.forEach((msg) => {
      if (msg.type === "MessageOutput" && "ok" in msg.output.result) {
        ...
        if (ok.flags.length && ok.flags[0] === "Revert" && this.#message.returnType) {
          const returns = this.#contract.abi.registry.createType(this.#message.returnType.type, (0, import_util9.hexToU8a)(ok.data));
...
var PinkContractPromise = class _PinkContractPromise {
  constructor(api, phatRegistry, abi, address, contractKey, provider) {
    ...
    this.#inkQuery = (isEstimating, messageOrId, options2, params) => {
      ...
      const { cert } = options2;
      const seed = (0, import_util9.hexToU8a)((0, import_util9.hexAddPrefix)(randomHex(32)));
      const pair = (0, import_util_crypto4.sr25519PairFromSeed)(seed);
      const [sk, pk] = [pair.secretKey, pair.publicKey];
      const queryAgreementKey = (0, import_util_crypto4.sr25519Agreement)(sk, (0, import_util9.hexToU8a)((0, import_util9.hexAddPrefix)(this.phatRegistry.remotePubkey)));
      const inkQueryInternal = async (origin) => {
        ...
        return {
          debugMessage,
          gasConsumed,
          gasRequired: gasRequired && !(0, import_util7.convertWeight)(gasRequired).v1Weight.isZero() ? gasRequired : gasConsumed,
    ...
    this.#inkCommand = (messageOrId, options2, params) => {
      options2.nonce && assert((0, import_util9.isHex)(options2.nonce) && options2.nonce.length === 66, "Invalid nonce provided");
      const nonce = options2.nonce || (0, import_util9.hexAddPrefix)(randomHex(32));
      ...
      const payload = command(
        ...
        nonce,
        options2.value,
        (0, import_util7.convertWeight)(options2.gasLimit || import_util9.BN_ZERO).v2Weight,
        options2.storageDepositLimit
      );
      return this.api.tx.phalaPhatContracts.pushContractMessage(this.address, payload.toHex(), options2.deposit || import_util9.BN_ZERO).withResultTransform((result) => {
        return new PinkContractSubmittableResult(
          ...
          message,
          result,
          (0, import_util8.applyOnEvent)(result, ["ContractEmitted", "ContractExecution"], (records) => {
            return records.map(
              ({
                event: {
                  data: [, data]
    ...
    this.abi.messages.forEach((meta) => {
      if (meta.isMutating) {
        this.#tx[meta.method] = (0, import_util7.withMeta)(
          meta,
          (options2, ...params) => {
            return this.#inkCommand(meta, options2, params);
          }
        );
        this.#query[meta.method] = (0, import_util7.withMeta)(
          meta,
    ...
    return new Proxy(
      {},
      {
        get: (_target, prop, _receiver) => {
          ...
          return (0, import_util7.withMeta)(meta[0], (options2, ...arags) => {
  ...
  async _send(messageOrId, options2, ...args) {
    ...
    const storageDepositFee = storageDeposit.isCharge ? storageDeposit.asCharge.toBn() : import_util9.BN_ZERO;
...
var PinkBlueprintPromise = class {
  constructor(api, phatRegistry, abi, codeHash) {
    this.#query = {};
    this.#tx = {};
    this.#deploy = (constructorOrId, { gasLimit = import_util11.BN_ZERO, storageDepositLimit = null, value = import_util11.BN_ZERO, deposit = import_util11.BN_ZERO, salt }, params) => {
      if (!salt) {
        salt = randomHex(4);
      }
    ...
    this.#estimateGas = (constructorOrId, options2, params) => {
      const seed = (0, import_util11.hexToU8a)((0, import_util11.hexAddPrefix)(randomHex(32)));
      const pair = (0, import_util_crypto5.sr25519PairFromSeed)(seed);
      const [sk, pk] = [pair.secretKey, pair.publicKey];
      const { cert } = options2;
      const queryAgreementKey = (0, import_util_crypto5.sr25519Agreement)(sk, (0, import_util11.hexToU8a)((0, import_util11.hexAddPrefix)(this.phatRegistry.remotePubkey)));
      const inkQueryInternal = async (origin) => {
        if (typeof origin === "string") {
          assert(origin === cert.address, "origin must be the same as the certificate address");
        } else if (origin.hasOwnProperty("verify") && origin.hasOwnProperty("adddress")) {
    ...
    this.abi.constructors.forEach((meta) => {
      if ((0, import_util11.isUndefined)(this.#tx[meta.method])) {
        this.#tx[meta.method] = (0, import_util10.createBluePrintTx)(
          meta,
          (o, p) => this.#deploy(meta, o, p)
        );
        this.#query[meta.method] = (0, import_util10.withMeta)(
          meta,
    ...
    return new Proxy(
      {},
      {
        get: (_target, prop, _receiver) => {
          ...
          return (0, import_util10.withMeta)(meta[0], (options2, ...arags) => {
            return this._send(prop, options2, ...arags);
          });
        }
      }
  ...
  async _send(constructorOrId, options2, ...args) {
    ...
    const gasLimit = gasRequired.refTime.toBn();
    const storageDepositFee = storageDeposit.isCharge ? storageDeposit.asCharge.toBn() : import_util11.BN_ZERO;
    const minRequired = gasLimit.mul(gasPrice).add(storageDepositFee);
    if (clusterBalance.free.lt(minRequired)) {
      const deposit = minRequired.sub(clusterBalance.free);
      if (onchainBalance.data.free.lt(deposit)) {
...
var PinkCodePromise = class {
  constructor(api, phatRegistry, abi, wasm) {
    ...
    this.#instantiate = (_constructorOrId, _params) => {
      return this.api.tx.phalaPhatContracts.clusterUploadResource(this.phatRegistry.clusterId, "InkCode", (0, import_util12.u8aToHex)(this.code)).withResultTransform((result) => {
    ...
    this.phatRegistry = phatRegistry;
    if ((0, import_util12.isWasm)(this.abi.info.source.wasm)) {
      this.code = this.abi.info.source.wasm;
    } else if ((0, import_util12.isU8a)(wasm)) {
      this.code = wasm;
    } else if (typeof wasm === "string" && wasm.substring(0, 2) === "0x") {
      this.code = (0, import_util12.hexToU8a)(wasm);
    } else {
      throw new Error("`wasm` should hex encoded string or Uint8Array.");
    }
    if (!(0, import_util12.isWasm)(this.code)) {
  ...
  async send({ provider }) {
    return await provider.send(
      this.api.tx.phalaPhatContracts.clusterUploadResource(this.phatRegistry.clusterId, "InkCode", (0, import_util12.u8aToHex)(this.code)),
...
var import_util13 = require("@polkadot/util");
...
function sidevmQueryWithReader({ phactory, remotePubkey, address, cert }) {
  return async function unsafeRunSidevmQuery(sidevmMessage) {
    ...
    const queryAgreementKey = (0, import_util_crypto6.sr25519Agreement)(sk, (0, import_util13.hexToU8a)((0, import_util13.hexAddPrefix)(remotePubkey)));
    ...
    const parsed = payload.substring(0, 2) === "0x" ? JSON.parse((0, import_util13.hexToString)(payload)) : JSON.parse(payload);
    if (parsed.error) {
...
function postProcessLogRecord(messages, abiLike) {
  ...
  return messages.map((message) => {
    ...
    if (message.type === "MessageOutput") {
      const execResult = phalaTypes.createType("ContractExecResult", (0, import_util13.hexToU8a)(message.output));
      ...
      try {
        const decoded = abi.decodeEvent((0, import_util13.hexToU8a)(message.payload));
...
function getTopicHash(topic) {
  ...
  if (encoded.length > 32) {
    return (0, import_util13.u8aToHex)((0, import_util_crypto6.blake2AsU8a)(encoded));
  } else {
    return (0, import_util13.u8aToHex)(encoded) + "00".repeat(32 - encoded.length);
  }
}
...
var import_util14 = require("@polkadot/util");
...
async function recoverEvmPubkey(client, account, msg = "Allows to access the pubkey address.") {
  ...
  const compressed = (0, import_util14.u8aToHex)((0, import_util_crypto9.secp256k1Compress)((0, import_util14.hexToU8a)(uncompressed)));
  return {
    uncompressed,
    compressed,
...
function evmPublicKeyToSubstrateRawAddressU8a(hex, converter = "EvmTransparentConverter") {
  let pubkey = (0, import_util14.hexToU8a)(hex);
...
function substrateRawAddressToEvmAddress(address) {
  ...
  return (0, import_util14.u8aToHex)(h20);
}
...
var _EvmAccountMappingProvider = class _EvmAccountMappingProvider {
  ...
  async ready(msg) {
    const version = __privateGet(this, _apiPromise2).consts.evmAccountMapping.eip712Version.toString();

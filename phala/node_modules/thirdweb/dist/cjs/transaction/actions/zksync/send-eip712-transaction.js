...
async function populateEip712Transaction(options) {
    ...
    if (!gas || !maxFeePerGas || !maxPriorityFeePerGas) {
            ...
            params: [
                {
                    ...
                    eip712Meta: {
                        ...eip712,
                        gasPerPubdata: gasPerPubdata ? (0, hex_js_1.toHex)(gasPerPubdata) : (0, hex_js_1.toHex)(50000n),
                        factoryDeps: eip712?.factoryDeps?.map((dep) => Array.from((0, viem_1.hexToBytes)(dep))),
                    },
                    type: "0x71",
                    // biome-ignore lint/suspicious/noExplicitAny: TODO add to RPC method types
                },
        ...
        gas = (0, bigint_js_1.toBigInt)(result.gas_limit) * 2n; // overestimating to avoid issues when not accounting for paymaster extra gas ( we should really pass the paymaster input above for better accuracy )

...
export declare const socialAuthOptions: readonly ["google", "apple", "facebook", "discord", "line", "x", "coinbase", "farcaster", "telegram", "twitch"];
export type SocialAuthOption = (typeof socialAuthOptions)[number];
export type OAuthOption = SocialAuthOption | "guest";
export declare const authOptions: readonly ["google", "apple", "facebook", "discord", "line", "x", "coinbase", "farcaster", "telegram", "twitch", "guest", "email", "phone", "passkey"];

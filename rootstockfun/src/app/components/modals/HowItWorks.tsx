      ...
      <div className="bg-gradient-to-br from-[#1a1a1a] to-[#2a2a2a] text-white rounded-xl w-full max-w-4xl p-6 md:p-8 shadow-2xl overflow-hidden relative h-[90vh] md:h-auto overflow-y-scroll">
        ...
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-verde to-aqua">
            Root 4 Fun: Revolutionizing Token Launches on Rootstock
          </h2>
          <button
            onClick={toggleModal}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="bg-[#252525] rounded-lg p-6 shadow-inner">
              ...
              <p className="mb-3">
                ...
                Once market cap reaches{" "}
                <strong className="text-naranja">1 RBTC (~$68.7K)</strong>, all
                remaining tokens and liquidity migrate to Symbiosis or Uniswap
              </p>
              <p className="mb-3">
                <span className="font-semibold text-verde">🪙 Strategy:</span>{" "}
                Launch, Lock & Earn
              </p>
              <p className="mb-3">
                <span className="font-semibold text-verde">🔒 Security:</span>{" "}
                All liquidity is locked forever
              </p>
              <p>
                <span className="font-semibold text-verde">🚀 Boost:</span> Free
                Enhanced Token Info gives all Root Fun tokens the best chance to
          ...
          <div className="space-y-6">
            <div className="bg-[#252525] rounded-lg p-6 shadow-inner">
              ...
              <p className="mb-3">
                Root Fun prioritizes the safety and fairness of all
                participants. Our platform ensures:
              </p>
            ...
            <div className="bg-[#252525] rounded-lg p-6 shadow-inner">
              ...
              <p className="text-gray-300 text-sm">
                Tokens launched on this platform are not endorsed by Root Fun.
                Root Fun is not an investment platform; your tokens could lose
                significant value at any time. Always conduct your own research
            ...
            <div className="flex flex-col space-y-4 mt-6">
              <button
                className="bg-gradient-to-r from-verde to-aqua text-black px-6 py-3 rounded-full font-bold text-lg hover:from-verde hover:to-aqua transition-all duration-300 shadow-lg"
                onClick={() => toggleModal()}
              >
                Explore Root Fun
              </button>
